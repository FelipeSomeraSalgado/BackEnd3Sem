...
public class UsuarioController : ControllerBase
{
    ...
    /// <summary>
    /// Endpoint da API faz a chamada para o método de buscar um usuário por id
    /// </summary>
    /// <param name="id">Id do usuário a ser buscardo</param>
    ...
    /// </summary>
    /// <param name="usuario">Usuário a ser chamado</param>
